...
#[component]
pub fn SidenavRoutesSimplified() -> Element {
    rsx! {
            ...
            div { class: "mx-auto grid max-w-7xl gap-6 px-6 py-8 lg:grid-cols-[18rem_minmax(0,1fr)]",
                aside { class: "flex flex-col rounded-xl border bg-sidenav p-3 text-sidenav-foreground shadow-sm",
                    div { class: "space-y-2 border-b border-sidenav-border/70 pb-3",
                        div { class: "text-lg font-semibold", "Sidenav Routes" }
                        p { class: "text-xs text-sidenav-foreground/70", "Browse the registry by section without the extra route chrome." }
                        div { class: "relative",
                    ...
                    div { class: "mt-auto border-t border-sidenav-border/70 pt-3 text-xs text-sidenav-foreground/70", "Route navigation" }
                }
                ...
                main { class: "rounded-xl border bg-background p-6 shadow-sm",
                    div { class: "space-y-4",
                        ...
                        h1 { class: "text-3xl font-semibold tracking-tight", "Sidenav Routes" }
                        p { class: "max-w-prose text-sm text-muted-foreground", "Browse the registry by section without the extra route chrome." }
