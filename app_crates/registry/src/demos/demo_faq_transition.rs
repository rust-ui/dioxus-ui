...
const FAQS: &[(&str, &str, &str)] = &[
    (
        "faq1",
        "What is Dioxus?",
        "Dioxus is a Rust framework for building fullstack web, desktop, and mobile apps with a single codebase.",
    ),
    (
        "faq2",
        "Is it production-ready?",
        "Dioxus has been used in production by many teams. It is actively maintained with a growing ecosystem.",
    ),
    (
        "faq3",
        "Does it support SSR?",
        "Yes! Dioxus supports server-side rendering, static site generation, and client-side rendering.",
    ),
];
