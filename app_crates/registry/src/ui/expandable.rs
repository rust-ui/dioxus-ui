...
#[component]
pub fn ExpandableTrigger(#[props(into, optional)] class: Option<String>, children: Element) -> Element {
...
#[component]
pub fn ExpandableTransition(#[props(into, optional)] class: Option<String>, children: Element) -> Element {
    let c = tw_merge!("absolute transition-opacity duration-200 delay-100", class.as_deref().unwrap_or(""));
    rsx! {
        div {
            class: "{c}",
...
#[component]
pub fn ExpandableContent(#[props(into, optional)] class: Option<String>, children: Element) -> Element {
