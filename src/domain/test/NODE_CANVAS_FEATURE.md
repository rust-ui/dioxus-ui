...
| **Minimap click-to-pan** — click minimap position to jump viewport            | Easy       | 🟡 Low   |
| **Read-only / locked mode** — prop that disables all mutations                | Easy       | 🟡 Low   |
...
| **Touch / trackpad support** — pinch-to-zoom, two-finger pan                  | Medium     | 🟡 Low   |
