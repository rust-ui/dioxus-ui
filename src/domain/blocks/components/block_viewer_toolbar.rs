        ...
        div { class: "hidden gap-2 items-center pl-2 w-full md:pr-6 lg:flex",
            ...
            div { class: "flex gap-2 items-center ml-auto",
                ...
                a {
                    ...
                    class: "inline-flex items-center gap-1 h-8 px-3 text-xs font-medium rounded-md border bg-background shadow-xs hover:bg-accent hover:text-accent-foreground transition-colors",
                    "View Md"
                }
            }
        }
