...
#[component]
pub fn FaqDescription(#[props(into, optional)] class: Option<String>, children: Element) -> Element {
...
pub fn FaqSection(#[props(into, optional)] class: Option<String>, children: Element) -> Element {
    let c = tw_merge!("w-full rounded bg-accent/30 hover:bg-accent flex flex-col", class.as_deref().unwrap_or(""));
